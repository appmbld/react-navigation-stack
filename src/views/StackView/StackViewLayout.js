...
class StackViewLayout extends React.Component {
  ...
  _isTrackingVelocity() {
    const trackVelocityEnabled = this.props.transitionProps.scene.descriptor
      .options.trackGestureVelocityEnabled;
    return typeof trackVelocityEnabled === 'boolean' ? trackVelocityEnabled : false;
  }
  ...
  _handleReleaseHorizontal(nativeEvent) {
    ...
    const shouldGoBackCriterion =
      (this._isTrackingVelocity() && gestureVelocity > 50) ||
